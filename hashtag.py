...
import os
import shutil
# from video_hashtag_generator import VideoHashtagGenerator  # type: ignore # Import the generator class

# from hashtag import VideoHashtagGenerator # type: ignore
...
async def generate_hashtags(
    ...
    try:
        ...
        # Process the video
        generator = VideoHashtagGenerator(temp_video_path, audio_path, frames_folder)
        transcript, image_descriptions, hashtags, caption = generator.process_video()
